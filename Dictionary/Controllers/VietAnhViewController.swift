...
class VietAnhViewController: UIViewController {
    ...
    @IBAction func searchVietAnhButton(_ sender: UIButton) {
        guard let input = txtValue.text else {
            return
        }
        if let encodedString  = input.addingPercentEncoding(withAllowedCharacters: .urlHostAllowed){
            let link = API.API_URL + "/s/" + encodedString + "/" + Language.vi.rawValue
...
extension VietAnhViewController:UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "vi: " + sentence.fields.vi.replacingOccurrences(of: "<em>", with: "").replacingOccurrences(of: "</em>", with: "")
        ...
        cell.detailTextLabel?.text = "en: " + sentence.fields.en
...
extension VietAnhViewController : UITextFieldDelegate {
